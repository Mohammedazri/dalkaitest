({
	...
	drawChart : function(component, chartData, chartOption){
        ...
        chartContainer.onclick = function(evt){
            ...
            // comented by chadi geara on the 24/1/2018
            // because we are Firing a Component Event, rather than Application Event "e"
            var e = component.getEvent("ChartjsChartClick");
            e.setParams({
